...
| 更新日 | 2026年9月15日（エントリー完了。#23 障害時のUIを確認し、見つかった4件を直した） |
| :--- | :--- |
...
| 2 | **本番では `?demo=` が効いていなかった** | キー未設定のモックモードでしか見ていなかった。キーがあっても固定応答を返し、カードに「デモ用の固定応答です」と出す |
...
| 5 | `should` | Anthropic 経路の動作確認 | キー入手時のみ。本選までに入手できなければ見送る | — | [#20](https://github.com/John-Frusciante/overlai/issues/20) |
...
| [本選](https://github.com/John-Frusciante/overlai/milestone/3) | 2026-10-01 | 進行中 | エントリー完了（9/15）・結果連絡は9/21頃。#20 #23〜#25 — ブース展示と連続デモに耐えるための整備 |
