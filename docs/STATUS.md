...
| 更新日 | 2026年9月15日（エントリー完了。本選向けの #23 #24 #25 がすべて完了。Anthropic 経路とモックモードを廃止。APIの応答と失敗の文言を共通化） |
| :--- | :--- |
...
- [ ] iOS 実機で、見出しの長押しがテキスト選択のメニューに負けずに初期化の確認を出すことを1回見る
...
- [ ] 展示の合間に初期化する手順（**マイストックの見出しを長押し → 戻す**）を、説明役以外のメンバーも覚えておく
