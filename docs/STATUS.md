...
| 更新日 | 2026年9月15日（ユメカタリにエントリー完了。本選に向けたタスクを整理） |
| :--- | :--- |
...
| 順 | 優先 | 項目 | なぜ | 目安 | Issue |
| :---: | :---: | :--- | :--- | :---: | :---: |
| 1 | `must` | 通信エラー時のUIを実際に確認する | 会場のネットワークで 429／タイムアウトが起きる確率は家より高い。**唯一の未検証領域**。`?demo=` の固定応答への切り替え手順もここで確かめる | 〜9/21（結果待ちの間） | [#23](https://github.com/John-Frusciante/overlai/issues/23) |
